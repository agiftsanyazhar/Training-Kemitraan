...
<a href="#" class="btn btn-light"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> Tambah Produk</a>
</div>
                    ...
                    {{--  <tr>
                        <td class="align-top border-right text-wrap" style="min-width: 280px">
                            <div class="d-flex">
                                ...
                                <div class="p-2 py-0 flex-shrink-0">
                                    <img src="https://dashboard.sellerkit.id/assets/img/products/SK_PRODUCT_5HDJpqMO.jpg" class="img-thumbnail img-fluid avatar-lg" style="object-fit: contain">
                                </div>
                                <div class="p-2 py-0 flex-grow-1">
                    ...
                    {{--  <tr>
                        <td class="align-top border-right text-wrap" style="min-width: 280px">
                            <div class="d-flex">
                                ...
                                <div class="p-2 py-0 flex-shrink-0">
                                    <img src="https://dashboard.sellerkit.id/assets/img/products/SK_PRODUCT_Updo6MnY.jpg" class="img-thumbnail img-fluid avatar-lg" style="object-fit: contain">
                                </div>
                                <div class="p-2 py-0 flex-grow-1">
